          ...
          <div className="space-y-2">
            <div>
              ...
              >
                ...
                {isRegeneratingAll ? "Queuing…" : "Queue New Images for All Scenes"}
              </button>
              <p className="text-xs text-white/15 mt-1 px-1">
                Clears cached images and re-generates as you read.
              </p>
            </div>
            <button
            ...
            >
              ...
              {isReanalyzing ? "Analyzing…" : "Re-analyze Book"}
            </button>
          </div>
        )}
      </div>
...
function LibrarySection({ onClose }: { onClose: () => void }) {
  const { library, removeBook, activeBook, setActiveBook } = useBookStore();
